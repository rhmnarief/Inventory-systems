...
<html lang="en">
<head>
  <title>Catatan Bahan Baku Masuk dan Keluar</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Record of Stocks</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex align-items-center" style="justify-content: space-between; width:auto;">
                <h3 class="card-title">Catatan Masuk dan Keluar Bahan Baku</h3>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    @foreach ($dataRecordStock as $record)
                    <tr>
                      <td>{{ $record->id }}</td>
                      <td>
                        {{ $record->id_stock }}
                      ...
                      <td>
                        {{ $dataFiltered->nama_bahan != null ? $dataFiltered->nama_bahan : 'Item Telah Dihapus' }}
                      </td>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('addRecordStock') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="form-floating">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" id="inputGroupSelect01" name="unique_code" style="width: 70%">
                            ...
                            <option value="{{ $item->kode_unik }}" name="unique_code" style="border-radius: 0" required>{{ $item->nama_bahan }}</option>
                            @endforeach
                        </select>
                    </div>
